...
String uid = cacheService.addStepSaveToList(new StepSave(stepService.stepListToMap(parserSteps.getSteps())));
Result result = cacheService.getCache().get(uid).getStepsObjectMap().get(parserSteps.getSteps().get(0));
